...
<body>
    ...
    <section class="breadcrumb breadcrumb_bg">
        <div class="container" style="margin-top: 150px; margin-bottom: 50px;">
          ...
          <div class="col-lg-5">
          <form class="" action="<?=ROOT_URL?>/php/signup.php" method="post">
          <h5>
            ...
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  <input class="form-control" name="comp_name" id="name" type="text" 
                    placeholder='Enter your company name'>
                </div>
              </div>
              <div class="col-sm-12">
                <div class="form-group">
                  <input class="form-control" name="desc" id="name" type="text" 
                    placeholder='Enter company decription'>
                </div>
              </div>
              <div class="col-sm-12">
                <div class="form-group">
                  <input class="form-control" name="email" id="name" type="email" 
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  <input class="form-control" name="cpassword" id="name" type="password" 
                    placeholder='Confirm your password'>
                </div>
              </div>
              <div class="col-sm-12">
                <h6>Have an account? <a href="signin.php">Sign in</a></h6>
              </div>
              <div class="col-sm-12">
                <div class="form-group">
                  <input class="form-control button btn_1" name="signup" type="submit" 
                    value='Sign up'>
                </div>
              </div>
            </div>
