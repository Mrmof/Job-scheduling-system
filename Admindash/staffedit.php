...
notsignedin();
$email = $_GET['email'];
$staffdata = "SELECT * FROM `staff` WHERE email = '$email'";
            ...
            <div class="col-lg-4">
                <div class="white_card card_height_100 mb_20">
                    ...
                    <div class="white_card_body d-flex align-items-center" style="height:140px">
                        <h4 class="f_w_900 f_s_60 mb-0 me-2"></h4>
        ...
        <div class="col-lg-4">
            ...
            ?>
                <div id="myModal" class="modal" style="display: block;">
                    <div class="modal-content" style="top: 15%;height: 40%;width: 40%;left: 40%;">
                        <span class="close" style=" width: 10%;font-size: 35px;padding: 10px;">&times;</span>
                        <p style="text-align: center; position: relative; height: 50%; top: 21%;"><?php echo $notification;?></p>
                    </div>
                </div>
            <?php  } };?>           
             <form class="form-group" action="<?=ROOT_URL?>php/staffedit.php" method="post" style="margin-bottom: 5.5rem">
                <div class="form-group">
                    <input type="text" class="form-control" name="staffname" placeholder="FullName" value="<?=$row['staff_name']?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="role" placeholder="role" value="<?=$row['role']?>">
                </div>
                <div class="form-group">
                    <input type="email" class="form-control" name="email" readonly value="<?=$row['email']?>">
                </div>
                <div class="form-group">
                    <input type="password" class="form-control" name="password" placeholder="Password" value="<?=$row['password']?>">
                </div>
                <div class="form-group">
                    <input type="password" class="form-control" name="cpassword" placeholder="Password" value="<?=$row['cpassword']?>">
                </div>
                <div class="form-group">
                    <input type="submit" class="form-control" name="updatestaff" value="Update">
                </div>
            </form>
        </div>
    </div>
