...
<!-- Mirrored from demo.dashboardpack.com/sales-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Apr 2023 17:28:12 GMT -->
<head>
...
<nav class="sidebar vertical-scroll  ps-container ps-theme-default ps-active-y">
    ...
    <ul id="sidebar_menu">
        <li class="mm-active">
            <a  href="<?=ROOT_URL?>Admindash/index.php">
                <div class="icon_menu">
        ...
        <li class="mm-active">
            <a  href="<?=ROOT_URL?>Admindash/staff.php">
                <div class="icon_menu">
        ...
        <li class="mm-active">
            <a  href="<?=ROOT_URL?>Admindash/jobandstatus.php">
                <div class="icon_menu">
        ...
        <li class="mm-active">
            <a  href="<?=ROOT_URL?>Admindash/jobscheduling.php">
                <div class="icon_menu">
        ...
        <li class="mm-active">
            <a  href="<?=ROOT_URL?>Admindash/history.php">
                <div class="icon_menu">
                    <img src="img/menu-icon/dashboard.svg" alt="">
                </div>
                <span>History</span>
        ...
        <li class="mm-active">
            <a  href="<?=ROOT_URL?>php/logout.php">
                <div class="icon_menu">
                    <!-- <img src="img/menu-icon/dashboard.svg" alt=""> -->
                </div>
                <span>Logout</span>
            ...
            <div class="col-lg-4">
                <div class="white_card card_height_100 mb_20">
                    ...
                    <div class="box_header m-0">
                        ...
                        <h3 class="m-0">Monthly Task Flow</h3>
                        </div>
...
<div class="col-lg-8">
    <div class="white_card card_height_100  mb_20">
        <div class="white_card_header">
            <div class=" m-0">
                <div class="">
                    <h3 class="m-0">Edit Staff Details</h3>
                    <table class="table bayer_table m-0">
                        <tbody>
                            <tr>
                                <td> 
                                    <h5 class="byer_name  f_s_16 f_w_700 color_theme">S/N</h5>    
                                </td>
                                <td> 
                                    <h5 class="byer_name  f_s_16 f_w_700 color_theme">Staff Name</h5>    
                                </td>
                                <td> 
                                    <h5 class="byer_name  f_s_16 f_w_700 color_theme">Email</h5>    
                                </td>
                                <td> 
                                    <h5 class="byer_name  f_s_16 f_w_700 color_theme">study</h5>    
                                </td>
                                <td> 
                                    <h5 class="byer_name  f_s_16 f_w_700 color_theme">Role</h5>    
                                </td>
                                <td> 
                                    <h5 class="byer_name  f_s_16 f_w_700 color_theme">Competency</h5>    
                                </td>
                                <td> 
                                    <h5 class="byer_name  f_s_16 f_w_700 color_theme">Edit</h5>    
                                </td>
                                <td> 
                                    <h5 class="byer_name  f_s_16 f_w_700 color_theme">Delete</h5>    
                                </td>
                            </tr>
                            <?php
                                       querystaffdata();
                            ...
                            <tr>
                                <td> 
                                    <h5 class="byer_name  f_s_16 f_w_700 color_theme"><?=$i?></h5>    
                                </td>
                                <td> 
                                    <h5 class="byer_name  f_s_16 f_w_700 color_theme"><?=$row['staff_name'] ?></h5>    
                                </td>
                                <td> 
                                    <h5 class="byer_name  f_s_16 f_w_700 color_theme"><?=$row['email'] ?></h5>    
                                </td>
                                <td> 
                                    <h5 class="byer_name  f_s_16 f_w_700 color_theme"><?=$row['study'] ?></h5>    
                                </td>
                                <td> 
                                    <h5 class="byer_name  f_s_16 f_w_700 color_theme"><?=$row['role'] ?></h5>    
                                </td>
                                <td> 
                                    <h5 class="byer_name  f_s_16 f_w_700 color_theme"><?=$row['compentency'] ?></h5>    
                                </td>
                                <td> 
                                    <h5 class="byer_name  f_s_16 f_w_700 color_theme"><a href="staffedit.php?email=<?=$row['email'] ?>">Edit</a></h5>    
                                </td>
                                <td> 
                                    <h5 class="byer_name  f_s_16 f_w_700 color_theme"><a href="<?=ROOT_URL?>php/delete.php?email=<?=$row['email']?>">Delete</a></h5>    
                                </td>
                            </tr>
                            <?php   
                                    $i++; }?>
...
<!-- Mirrored from demo.dashboardpack.com/sales-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Apr 2023 17:31:00 GMT -->
</html>
