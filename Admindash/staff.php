...
<div class="main_content_iner overly_inner ">
            ...
            <div class="col-lg-4">
                <div class="white_card card_height_100 mb_20">
                    ...
                    <div class="white_card_body d-flex align-items-center" style="height:140px">
                        <h4 class="f_w_900 f_s_60 mb-0 me-2"><?=countstaff()?></h4>
    ...
    <div class="row">
        <div class="col-lg-4">
            <form class="form-group mb-4" action="<?=ROOT_URL?>php/addstaff.php" method="post">
                <div class="form-group">
                    <input type="text" class="form-control" name="staffname" placeholder="FullName">
                </div>
                <div class="form-group">
                    <select name="competency" class="form-control">
                        <option value="">-Choose staff competency level</option>
                ...
                <div class="form-group">
                    <select name="study" class="form-control">
                        <option value="">-Choose staff Field</option>
                        <option value="pharmacist"> Pharmacist</option>
                        <option value="surgeon">Surgeon</option>
                        <option value="nurse">Nurse</option>
                        <option value="front desk officier">Front desk Officer</option>
                ...
                <div class="form-group">
                    <input type="submit" class="form-control" name="addstaff" value="Add Staff">
                </div>
            </form>
        </div>
        <div class="col-lg-12">
