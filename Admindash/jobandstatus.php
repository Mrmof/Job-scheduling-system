...
<div class="main_content_iner overly_inner ">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="white_card card_height_100 mb_20">
                    ...
                    <div class="white_card_body d-flex align-items-center" style="height:140px">
                        <h4 class="f_w_900 f_s_60 mb-0 me-2"><?=completed()?></h4>
            ...
            <div class="col-lg-4">
                <div class="white_card card_height_100 mb_20">
                    ...
                    <div class="white_card_body d-flex align-items-center" style="height:140px">
                        <h4 class="f_w_900 f_s_60 mb-0 me-2"><?=running()?></h4>
                            <div class="w-100" style="height:100px">
                            <!-- <canvas width="100%" id="page_views"></canvas> -->
                            </div>
                    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 mt-3" >
                ...
                <div class="card">
                    <div class="card-body">
                        <embed src="<?=$row['img']?>"  alt="" type="application/pdf">
                        <div class="card-title">
                            <a href="<?=$row['img']?>">Download</a>
                        </div>
                        <div class="card-text">
                            <span>Staff Name:<?= $row['Staff_name']?></span>
                        </div>
                        <div class="card-text">
                            <span>Competency: <?= $row['compentency']?></span>
                        </div>
                        <div class="card-text">
                            <span>Commenced:<?= $row['date']?></span>
                        </div>
                        <div class="card-text">
                            <span>Expiry Date:<?= $row['due_date']?></span>
                        </div>
                        <div class="card-text">
                            <span>Status: <?= $row['status']?></span>
                        </div>
                        <div class="card-text">
                            <h5 class="byer_name  f_s_16 f_w_700 color_theme"><a href="<?=ROOT_URL?>php/deletejob.php?Tasks=<?=$row['Tasks']?>">Delete</a></h5> 
                        </div>
                    </div>
                </div>
