...
<div class="main_content_iner overly_inner ">
    ...
    <div class="row">
        ...
        <h5>
            ...
            <form class="form-group mb-4" action="<?=ROOT_URL?>php/jobscheduling.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <select name="competency" class="form-control">
                        <option value=""> Choose competency level </option>
                ...
                <div class="form-group">
                    <label for="">Due date: </label><input type="date" class="form-control" name="due_date" placeholder="Due date">
                </div>
                <div class="form-group">
                    <input type="submit" class="form-control" name="assigntask" value="Assign Task">
                </div>
            </form>
            <?php
