                ...
                <div class="col-lg-7">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            <h1>Building workplace efficiency and productivity reliably</h1>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6 col-lg-5">
                    <div class="about_us_text">
                        ...
                        <h2>Automated<br>
                            work scheduling system</h2>
                        <p>This system auto-assigns task to available staff daily inother to promote and ensure productivity.</p>
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="about_us_text">
                        ...
                        <p>The system ensures computerized coordination of human resource outlining competency levels amongst staff. This provide also the priviledge of active decision making in recruitment processes.</p>
                        <!-- <a href="#" class="btn_2">learn more</a> -->
                    </div>
                </div>
            </div>
