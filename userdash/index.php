...
<nav class="sidebar vertical-scroll  ps-container ps-theme-default ps-active-y">
    ...
    <ul id="sidebar_menu">
        <li class="mm-active">
            <a  href="<?=ROOT_URL?>userdash/index.php">
                <div class="icon_menu">
        ...
        <li class="mm-active">
            <a  href="<?=ROOT_URL?>userdash/jobandstatus.php">
                <div class="icon_menu">
        ...
        <li class="mm-active">
            <a  href="<?=ROOT_URL?>userdash/history.php">
                <div class="icon_menu">
                    <img src="img/menu-icon/dashboard.svg" alt="">
                </div>
                <span>History</span>
...
<div class="profile_info">
    ...
    <div class="main_content_iner overly_inner ">
        <div class="container-fluid p-0 ">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <h4 class="f_w_900 f_s_60 mb-0 me-2"><?php echo usertaskcount();?></h4>
        ...
        <div class="white_card card_height_100 mb-2">
            <div class="white_card_header">
                <div class=" m-0">
                    <div class="">
